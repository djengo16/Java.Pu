				...
				if (textField.getText() != null && !textField.getText().isEmpty()) {
					try {
						...
						if (intValue >= 1 && intValue <= 5) {
								...
								parentGui.sortTable(intValue, parentGui.table, PersonDataGUI.people,sortOrder);
								clearAndHide();
						...
						// Случай, в който потребиталят въведе String

						JOptionPane.showMessageDialog(CustomDialog.this,
								"Съжаляваме, въвели сте неправилна стойност!",
								"Грешка", JOptionPane.ERROR_MESSAGE);
					}
				} else {
