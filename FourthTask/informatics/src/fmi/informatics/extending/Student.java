...
public class Student extends Person {
	...
	public static class StudentGenerator {
		private static String[] names = {"Ivan", "Mariya", "Stoyan", "Petyr", "Petya", "Lilly","Stoyko","Rositsa","Svetla"};
		private static String[] specialities = {"Informatics", "STD", "BIT", "Mathematics","Biological"};
		private static String[] universities = {"PU", "NBU", "SU", "UHT","TU"};
